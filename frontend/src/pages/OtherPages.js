    ...
    const shareLink = () => {
      if (navigator.share) {
        navigator.share({
          ...
          text: `Join MatkaKing! Use my referral code: ${referralCode} and You get 5% bonus On First Deposite. 🎉`,
          url: referralLink,
        });
      } else {
        copyLink();
    ...
    return (
      <div style={B.page}>
        ...
        <div style={{ background: 'linear-gradient(135deg, #021a14, #063d35)', margin: '16px 12px', borderRadius: 20, padding: '24px 20px', textAlign: 'center', boxShadow: '0 0 20px rgba(0,255,213,0.1)', border: '1px solid rgba(0,255,213,0.2)' }}>
          ...
          <div style={{ color: '#FFD700', fontWeight: 900, fontSize: 22, marginBottom: 6, textShadow: '0 0 10px rgba(255,215,0,0.4)' }}> Get 5% Bonus!</div>
