...
export const GAME_TYPES = [
  ...
  {id:'family_pana',       label:'FAMILY PANA',       icon:'single_pana',    desc:'Puri family ki panas cover',  win:'150×', numType:'pana_bulk'},
  {id:'family_jodi',       label:'FAMILY JODI',       icon:'jodi',           desc:'Family ki saari jodis cover', win:'90×',  numType:'jodi_bulk'},
  {id:'half_sangam_a',     label:'HALF SANGAM BULK',  icon:'half_sangam',    desc:'Open digit + close pana',     win:'1000×',numType:'sangam'},
...
// Disawar ke liye sirf 2 game types
export const DISAWAR_GAME_TYPES = [
  {id:'single_digit', label:'SINGLE DIGIT', icon:'single_digit', desc:'Pick 1 digit (0–9)',       win:'9×',  numType:'ank'},
  {id:'jodi_digit',   label:'JODI DIGIT',   icon:'jodi',         desc:'Pick 2-digit Jodi 00–99',  win:'90×', numType:'jodi'},
];
